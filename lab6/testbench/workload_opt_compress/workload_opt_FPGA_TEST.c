...
void main()
{
	...
	reg_mprj_datal = 0xAB400000; while(reg_mprj_datah == 0);
	...
	// FIR Finish
	reg_mprj_datal = 0xAB410000; while(reg_mprj_datah == 1);

	//----- Start Matmul
	// Flag start of the test 
	reg_mprj_datal = 0xAB500000;  while(reg_mprj_datah == 2);

	tmp = matmul();
	reg_mprj_datal = *tmp << 16; while(reg_mprj_datah == 3);
	reg_mprj_datal = *(tmp+1) << 16; while(reg_mprj_datah == 4);
	reg_mprj_datal = *(tmp+2) << 16; while(reg_mprj_datah == 5);
	reg_mprj_datal = *(tmp+3) << 16; while(reg_mprj_datah == 6);

	// Finish Matmul
	reg_mprj_datal = 0xAB510000; while(reg_mprj_datah == 7);

	//----- Start Quick Sort
	// Flag start of the test 
	reg_mprj_datal = 0xAB600000; while(reg_mprj_datah == 8);
